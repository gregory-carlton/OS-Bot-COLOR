...
from model import Bot, RuneLiteBot, gcbot
...
class App(customtkinter.CTk):
    ...
    def build_ui(self):  # sourcery skip: merge-list-append, move-assign-in-block
        ...
        for name in names:
            ...
            if obj is not Bot and obj is not RuneLiteBot and obj is not gcbot and isinstance(obj, type) and issubclass(obj, Bot):
                instance = obj()
